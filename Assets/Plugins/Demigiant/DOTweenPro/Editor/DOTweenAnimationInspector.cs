...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        private static readonly Dictionary<DOTweenAnimationType, Type[]> _AnimationTypeToComponent = new()
        {
            {
                DOTweenAnimationType.Move,
                new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(RectTransform), typeof(Transform) }
            },
            ...
            {
                DOTweenAnimationType.Color,
                new[] { typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(Light) }
            },
            {
                DOTweenAnimationType.Fade,
                new[]
                {
                    typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(CanvasGroup),
                    typeof(Light)
                }
            },
...
#if DOTWEEN_TK2D
        static readonly Dictionary<DOTweenAnimationType, Type[]> _Tk2dAnimationTypeToComponent =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               new Dictionary<DOTweenAnimationType, Type[]>() {
...
#endif
#if DOTWEEN_TMP
        static readonly Dictionary<DOTweenAnimationType, Type[]> _TMPAnimationTypeToComponent =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       new Dictionary<DOTweenAnimationType, Type[]>() {
...
//                _src.animationType = (DOTweenAnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
            _src.isActive =
                EditorGUILayout.Toggle(new GUIContent("", "If unchecked, this animation will not be created"),
                    _src.isActive, GUILayout.Width(16));
            GUI.enabled = _src.isActive;
            _src.animationType = AnimationToDOTweenAnimationType(
                _AnimationType
            ...
            if (prevAnimType != _src.animationType)
            {
                ...
                switch (_src.animationType)
                {
                    ...
                    case DOTweenAnimationType.PunchScale:
                        _src.endValueV3 = _src.animationType == DOTweenAnimationType.PunchRotation
                            ? new Vector3(0, 180, 0)
                            : Vector3.one;
                    ...
                    case DOTweenAnimationType.ShakeScale:
                        _src.endValueV3 = _src.animationType == DOTweenAnimationType.ShakeRotation
            ...
            if (prevAnimType != _src.animationType || ComponentsChanged())
            {
                ...
                if (_src.animationType == DOTweenAnimationType.Fade && _src.GetComponent<CanvasGroup>() != null &&
                    _src.GetComponent<Image>() != null)
                {
                ...
                _src.forcedTargetType != TargetType.Unset)
            {
                ...
                _src.forcedTargetType = (TargetType)Enum.Parse(typeof(TargetType),
            ...
            switch (_src.animationType)
            {
                ...
                case DOTweenAnimationType.ShakeScale:
                    ...
                    _src.optionalFloat0 =
                        EditorGUILayout.Slider(new GUIContent("    Randomness", "The shake randomness"),
        ...
        private DOTweenAnimationType AnimationToDOTweenAnimationType(string animation)
        {
        ...
        private int DOTweenAnimationTypeToPopupId(DOTweenAnimationType animation)
        {
        ...
        private void GUIEndValueV3(bool optionalTransform = false)
        {
            GUILayout.BeginHorizontal();
            GUIToFromButton();
