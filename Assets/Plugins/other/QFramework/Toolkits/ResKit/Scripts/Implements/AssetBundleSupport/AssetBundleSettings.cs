...
namespace QFramework
{
    public class AssetBundleSettings
    {
        ...
        public static IResDatas AssetBundleConfigFile
        {
            get
            {
                if (mAssetBundleConfigFile == null) mAssetBundleConfigFile = mAssetBundleConfigFileFactory.Invoke();
        ...
        {
            string retName = null;
            var parren = AssetBundlePathHelper.StreamingAssetsPath + "AssetBundles/" +
        ...
        {
            var retUrl = AssetBundlePathHelper.PersistentDataPath + "AssetBundles/" +
        ...
        public static string RELATIVE_AB_ROOT_FOLDER =>
            "/AssetBundles/" + AssetBundlePathHelper.GetPlatformName() + "/";
