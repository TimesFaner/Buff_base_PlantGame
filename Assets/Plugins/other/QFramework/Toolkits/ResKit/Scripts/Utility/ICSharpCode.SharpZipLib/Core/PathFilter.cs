...
namespace ICSharpCode.SharpZipLib.Core
{
    ...
    public class ExtendedPathFilter : PathFilter
    {
        ...
        public long MinSize
        {
            ...
            set
            {
                if (value < 0 || maxSize_ < value) throw new ArgumentOutOfRangeException("nameof(value)");
        ...
        public long MaxSize
        {
            ...
            set
            {
                if (value < 0 || minSize_ > value) throw new ArgumentOutOfRangeException("nameof(value)");
        ...
        public DateTime MinDate
        {
            ...
            set
            {
                if (value > maxDate_) throw new ArgumentOutOfRangeException("nameof(value)", "Exceeds MaxDate");
        ...
        public DateTime MaxDate
        {
            ...
            set
            {
                if (minDate_ > value) throw new ArgumentOutOfRangeException("nameof(value)", "Exceeds MinDate");
