...
namespace ICSharpCode.SharpZipLib.GZip
{
    ...
    public class GZipOutputStream : DeflaterOutputStream
    {
        ...
        public override void Finish()
        {
            ...
            if (state_ == OutputState.Header) WriteHeader();
        ...
        private void WriteHeader()
        {
            if (state_ == OutputState.Header)
            {
                ...
                var mod_time =
                    (int)((DateTime.Now.Ticks - new DateTime(1970, 1, 1).Ticks) /
                          10000000L); // Ticks give back 100ns intervals
                byte[] gzipHeader =
                {
                    // The two magic bytes
        ...
        /// </param>
        public GZipOutputStream(Stream baseOutputStream, int size) : base(baseOutputStream,
