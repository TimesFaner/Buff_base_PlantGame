    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        public int FindEntry(string name, bool ignoreCase)
        {
            ...
            for (var i = 0; i < entries_.Length; i++)
                if (string.Compare(name, entries_[i].Name,
        ...
        private long TestLocalHeader(ZipEntry entry, HeaderTest tests)
        {
            lock (baseStream_)
            {
                    ...
                    ((size > 0 || compressedSize > 0) && entry.Size > 0))
                {
                    ...
                    if (compressedSize != 0
                        && compressedSize != entry.CompressedSize && compressedSize != 0xFFFFFFFF &&
                        compressedSize != -1)
                        throw new ZipException(
        ...
        */
        ...
        private int FindExistingUpdate(ZipEntry entry)
        {
            ...
            if (updateIndex_.ContainsKey(convertedName)) result = updateIndex_[convertedName];
            /*
        ...
        private class UpdateComparer : IComparer<ZipUpdate>
        {
            ...
            public int Compare(ZipUpdate x, ZipUpdate y)
            {
                ...
                {
                    var xCmdValue = x.Command == UpdateCommand.Copy || x.Command == UpdateCommand.Modify ? 0 : 1;
                    var yCmdValue = y.Command == UpdateCommand.Copy || y.Command == UpdateCommand.Modify ? 0 : 1;
...
#pragma warning restore 0219
    ...
    public class DiskArchiveStorage : BaseArchiveStorage
    {
        ...
        {
            if (temporaryStream_ != null) temporaryStream_.Dispose();
        }
