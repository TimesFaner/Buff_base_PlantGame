...
namespace QFramework
{
    public static class CodeGenHelper
    {
        public static GameObject GetBindBelongs2GameObject(AbstractBind bind)
        {
            ...
            {
                if (trans.parent.GetComponent<IBindGroup>() != null) return trans.parent.gameObject;
        ...
        {
            if (component.GetComponent<ViewController>()) return true;
        ...
        public static string GetBindBelongs2(AbstractBind bind)
        {
            ...
            while (trans.parent != null)
            {
                ...
                if (trans.parent.IsUIPanel()) return "UIPanel" + "(" + trans.parent.name + ")";
        ...
        {
            if (component.GetComponent("UIPanel")) return true;
