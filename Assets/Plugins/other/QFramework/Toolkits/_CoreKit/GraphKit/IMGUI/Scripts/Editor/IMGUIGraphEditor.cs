...
namespace QFramework
{
    ...
    public class GUIGraphEditor : GUIGraphEditorBase<GUIGraphEditor, GUIGraphEditor.CustomNodeGraphEditorAttribute,
        GUIGraph>
    {
        ...
        {
            var pos = GUIGraphWindow.current.WindowToGridPosition(Event.current.mousePosition);
        ...
        public virtual Gradient GetNoodleGradient(GUIGraphNodePort output, GUIGraphNodePort input)
        {
            ...
            if (input == null)
            {
                ...
                grad.SetKeys(
                    new GradientColorKey[] { new(a, 0f) },
                    new GradientAlphaKey[] { new(0.6f, 0f) }
                );
            }
            ...
            else
            {
                ...
                grad.SetKeys(
                    new GradientColorKey[] { new(a, 0f), new(b, 1f) },
