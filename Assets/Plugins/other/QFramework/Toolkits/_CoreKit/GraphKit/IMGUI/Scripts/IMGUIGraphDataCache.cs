...
namespace QFramework
{
    ...
    public static class GUIGraphDataCache
    {
        ...
        public static void UpdatePorts(GUIGraphNode node, Dictionary<string, GUIGraphNodePort> ports)
        {
            ...
            var staticPorts = new Dictionary<string, GUIGraphNodePort>();
            var removedPorts =
                new Dictionary<string, List<GUIGraphNodePort>>();
            var nodeType = node.GetType();

            var dynamicListPorts = new List<GUIGraphNodePort>();
            ...
            foreach (var staticPort in staticPorts.Values)
                ...
                {
                    var port = new GUIGraphNodePort(staticPort, node);
        ...
        private static bool IsDynamicListPort(GUIGraphNodePort port)
        {
            ...
            {
                var inputAttribute = x as GUIGraphNode.InputAttribute;
                var outputAttribute = x as GUIGraphNode.OutputAttribute;
        ...
        private static void BuildCache()
        {
            ...
            var baseType = typeof(GUIGraphNode);
        ...
        {
            [SerializeField] private List<Type> keys = new();
            [SerializeField] private List<List<GUIGraphNodePort>> values = new();
