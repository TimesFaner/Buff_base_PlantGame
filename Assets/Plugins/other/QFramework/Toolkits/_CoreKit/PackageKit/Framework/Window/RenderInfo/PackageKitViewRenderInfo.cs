...
namespace QFramework
{
    internal class PackageKitViewRenderInfo
    {
        ...
        {
            if (LocaleKitEditor.IsCN.Value && DisplayNameCN.IsNotNullAndEmpty()) return DisplayNameCN;

            if (!LocaleKitEditor.IsCN.Value && DisplayNameEN.IsNotNullAndEmpty()) return DisplayNameEN;
