...
namespace MoonSharp.Interpreter.Loaders
{
	...
	public class UnityAssetsScriptLoader : ScriptLoaderBase
    {
        ...
        private void LoadResourcesUnityNative(string assetsPath)
        {
            try
            {
                var array = Resources.LoadAll(assetsPath, typeof(TextAsset));

                for (var i = 0; i < array.Length; i++)
                {
                    var o = (TextAsset)array[i];
		...
		void LoadResourcesWithReflection(string assetsPath)
		{
			try
			{
				...
				MethodInfo textAssetNameGet =
																																																													                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Framework.Do.GetGetMethod(Framework.Do.GetProperty(textAssetType, "name"));
				MethodInfo textAssetTextGet =
																																																																                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Framework.Do.GetGetMethod(Framework.Do.GetProperty(textAssetType, "text"));
