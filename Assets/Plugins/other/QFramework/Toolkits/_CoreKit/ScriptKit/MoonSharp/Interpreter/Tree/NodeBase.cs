...
namespace MoonSharp.Interpreter.Tree
{
    internal abstract class NodeBase
    {
        ...
        protected ScriptLoadingContext LoadingContext { get; }
        ...
        protected static Token CheckMatch(ScriptLoadingContext lcontext, Token originalToken,
            TokenType expectedTokenType, string expectedTokenText)
        {
            var t = lcontext.Lexer.Current;
