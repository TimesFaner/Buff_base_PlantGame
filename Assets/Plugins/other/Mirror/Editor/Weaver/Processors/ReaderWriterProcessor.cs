...
namespace Mirror.Weaver
{
    public static class ReaderWriterProcessor
    {
        ...
        private static bool LoadMessageReadWriter(ModuleDefinition module, Writers writers, Readers readers,
        ...
        private static void AddRuntimeInitializeOnLoadAttribute(AssemblyDefinition assembly, WeaverTypes weaverTypes,
        ...
        private static void AddInitializeOnLoadAttribute(AssemblyDefinition assembly, WeaverTypes weaverTypes,
            MethodDefinition method)
        {
            // NOTE: previously we used reflection because according paul,
            // 'weaving Mirror.dll caused unity to rebuild all dlls but in wrong
