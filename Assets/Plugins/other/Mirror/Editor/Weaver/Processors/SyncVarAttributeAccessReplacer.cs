...
namespace Mirror.Weaver
{
    public static class SyncVarAttributeAccessReplacer
    {
        ...
        private static int ProcessInstruction(Logger Log, SyncVarAccessLists syncVarAccessLists, MethodDefinition md,
        ...
        private static void ProcessSetInstruction(SyncVarAccessLists syncVarAccessLists, MethodDefinition md,
            Instruction i, FieldDefinition opField)
        {
        ...
        private static void ProcessGetInstruction(SyncVarAccessLists syncVarAccessLists, MethodDefinition md,
            Instruction i, FieldDefinition opField)
        {
            // don't replace property call sites in constructors
            if (md.Name == ".ctor")
        ...
        private static int ProcessLoadAddressInstruction(SyncVarAccessLists syncVarAccessLists, MethodDefinition md,
