...
namespace ParrelSync
{
    ...
    public class ListOfStringsPreference
    {
        ...
        {
            return Deserialize(EditorPrefs.GetString(Key));
        }

        public void SetStoredValue(List<string> strings)
        {
            EditorPrefs.SetString(Key, Serialize(strings));
        }
    ...
    public class Preferences : EditorWindow
    {
        ...
        public static ListOfStringsPreference OptionalSymbolicLinkFolders =
            new("ParrelSync_OptionalSymbolicLinkFolders");
        ...
        private void OnGUI()
        {
            ...
            var optionalFolderPaths = OptionalSymbolicLinkFolders.GetStoredValue();
            var optionalFolderPathsAreDirty = false;

            // append a new row if full
            if (optionalFolderPaths.Last() != "") optionalFolderPaths.Add("");
